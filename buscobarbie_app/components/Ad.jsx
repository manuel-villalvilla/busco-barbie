...
export default withContext(function Ad({ ad, context: { setSearchHeight, favorites } }) {
  ...
  const [stateCategories, setStateCategories] = useState(
    ad.categories === 'soldmodels' ? 'Venta de modelos'
      : ad.categories === 'soldaccessories' ? 'Venta de complementos'
        : ad.categories === 'searchedmodels' ? 'Busco modelos'
          : ad.categories === 'searchedaccessories' ? 'Busco complementos'
            : null
  )
  ...
  return <>
    <div className={styles.adContainer}>
      ...
      <div className={styles.favorite}>
        {ad.categories === 'searchedmodels' || ad.categories === 'searchedaccessories' ?
          <span className={styles.searchLabel}>Busco</span>
          :
          <span className={styles.sellLabel}>Vendo</span>}
        ...
        {ad.image.length > 0 && <>
          <div className={styles.carouselContainer}>
            <Carousel
              ...
              dynamicHeight={true}
              showThumbs={false}
              statusFormatter={(currentItem, total) => <span
      ...
      <div className={styles.footerCategories}>
        ...
        <div className={styles.tagsContainer}>{ad.tags.map((tag, index) =>
          <p key={index}><svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
            width="24">
      ...
      <div className={styles.footerPriceProvince}>
        <div className={styles.footerPrice}>
          {(ad.categories === 'searchedmodels' || ad.categories === 'searchedaccessories') &&
            <p className={styles.offers}>Ofrezco</p>}
          {ad.price.negotiable &&
            <p className={styles.negotiable}>Negociable</p>}
      ...
      <AnimateHeight
        ...
        onHeightAnimationEnd={height => handleAnimationHeightChange(height)}>
      ...
      <AnimateHeight
        ...
        duration={500}
        height={reportHeight}
        onHeightAnimationEnd={height => handleReportAnimationHeightChange(height)}>
